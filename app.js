...
app.use(expressSession({
  ...
  store: MongoStore.create({
    mongoUrl: 'mongodb+srv://1mustyz:z08135696959@srms-demo.2x0dm.mongodb.net/myFirstDatabase?retryWrites=true&w=majority',
    ttl: 14 * 24 * 60 * 60,
    autoRemove: 'native',
  }),
...
// //connect to db
mongoose.connect('mongodb+srv://1mustyz:z08135696959@srms-demo.2x0dm.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', {
